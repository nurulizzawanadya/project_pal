  ...
  <div class="main-content" id="panel">
              ...
              <a class="nav-link pr-5" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-3  d-none d-lg-block">
                    <span class="mb-10 text-md  font-weight-bold">data</span>
                  </div>
                </div>
              </a>
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        ...
        <form method="post" action="{{url('/helpdesk/update/'.$data->id)}}" enctype="multipart/form-data" >
        {{ csrf_field() }}
        <div class="col-sm-5">
        ...
        <div class="col-sm-5">
            ...
            <input type="text" name="trouble" required="required" value="trouble" class="form-control" readonly value="{{ $data->trouble }}">
        </div>
        <div class="col-sm-5">
        ...
        <div class="col-sm-5">
         ...
         <div class="col-sm-5">
          <label for="rating">rating </label><br>
             <input type="text" name="rating" required="required" class="form-control" value="{{ $data->rating }}" >
        </div>
        <div class="col-sm-5">
            <label for="solved">Solved </label><br>
            <textarea name="solved" required="required" class="form-control" rows="7">{{ $data->solved }}</textarea>
        </div>
        <div class="col-sm-5">
            <label for="ttd">TTD </label><br>
            <a href="/ttd2/{{ $data->id_helpdesk }}">ttd disini</a>
            <br/>
            <input type="text" name="ttd" required="required" class="form-control" value="{{ $data->ttd }}">
           
        </div>
        <div class="col-sm-5">
            <label for="officer">Officer </label><br>
            <input type="text" name="officer" required="required" class="form-control" value="{{ $data->officer }}">

        </div>
        
        <div class="col-sm-5">
            <label for="foto_akhir">Foto Akhir </label><br>
            <input type="file" name="foto_akhir" id="foto_akhir" class="form-control" value="{{ $data->foto_akhir }}">
        </div>
        <div class="col-sm-5">
        ...
        <a href="{{url('/helpdesk/detailhelpdesk/'.$data->id_helpdesk)}}" class="btn btn-dark" style="margin-top: 30px; margin-right: 20px">Kembali</a>
    </form>
            <br>
            <!-- Light table -->
