                  ...
                  <div class="row">
                    <div class="col-sm-9">
                      <div class="form-group">
                          ...
                          <form class="form-inline" action="{{url('/search-nip')}}" method="post">
                          <input type="search" class="form-control" placeholder="Cari NIP..." name="cari" aria-label="search">
            ...
            <div class="card-header">
              ...
              <!--   <div class="col-4 text-right">
                  <a href="#!" class="btn btn-sm btn-primary">Settings</a>
                    ...
                    <div class="card-body">
                <h1 class="heading-small mb-4" style="font-size: 24px"><b> List Laporan Gangguan</b></h1>
              ...
              <table class="table table-bordered align-items-center table-md">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="gangguan">Gangguan</th>
                ...
                <tbody>
                  @foreach($helpdesk as $h)
                    <tr>
                    <td  scope="col">{{$h->tgl_pengajuan}}</td>
                    <td scope="col">{{$h->user->nama}}</td>
                    <td class="text-wrap" scope="col">{{$h->detailkategori->detail}}</td>
                    <td class="text-wrap" scope="col">{{$h->trouble}}</td>
                    <td>
                   
                    @if ($h->status == '0')
                         <a href ="{{url('/infonip/tampil/'.$h->id_helpdesk)}}"> <button role="button" style='color:#fff;' class="btn btn-danger" type="button"></i> Waiting</button></a>
                      @elseif ($h->status == '1')
                          <a href ="{{url('/infonip/tampil/'.$h->id_helpdesk)}}"><button role="button" style='color:#fff;' class="btn btn-danger" type="button"></i> Pending</button></a>
                      @elseif($h->status == '2')
                        <a href ="{{url('/infonip/tampil/'.$h->id_helpdesk)}}"> <button role="button" style='background-color: #e7e7e7; color: black; border-color: #e7e7e7' class="btn btn-info" type="button"></i> Proses</button></a>
                     @elseif ($h->status == '3') 
                        <a href ="{{url('/infonip/tampil/'.$h->id_helpdesk)}}"><button  role="button" style='color:#fff;' class="btn btn-success" type="button"></i> Solved</button></a>
                        @endif
                        </td>
                </tr>
                @endforeach
