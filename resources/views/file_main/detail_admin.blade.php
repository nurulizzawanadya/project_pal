  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        ...
        <form method="get" action="{{url('/halamanadmin/edit/'.$admin->id_helpdesk )}}" >
        {{ csrf_field() }}
        <div class="col-sm-5">
        ...
        <div class="col-sm-5">
            ...
            <input type="text" name="trouble" required="required" value="trouble" class="form-control" readonly value="{{ $admin->ket_masalah }}">
        </div>
        <div class="col-sm-5">
        ...
        <div class="col-sm-5">
         ...
         <div class="col-sm-5">
          <label for="rating">rating </label><br>
             <input type="text" name="rating" required="required" class="form-control" value="{{ $admin->rating }}" readonly>
        </div>
        <div class="col-sm-5">
            <label for="solved">Solved </label><br>
            <textarea name="solved" required="required" class="form-control" rows="7" readonly>{{ $admin->solved }}</textarea>
        </div>
        <div class="col-sm-5">
            <label for="ttd">TTD </label><br>
            <input type="text" name="ttd" required="required" class="form-control" value="{{ $admin->ttd }}" readonly>
        </div>
        <div class="col-sm-5">
            <label for="officer">Officer </label><br>
            <input type="text" name="officer" required="required" class="form-control" value="{{ $admin->officer }}" readonly>

        </div>
        
        <div class="col-sm-5">
            <!-- <label for="foto_akhir">Foto Akhir </label><br> -->
            <input type="hidden" name="foto_akhir" id="foto_akhir" class="form-control" value="{{ $admin->foto_akhir }}">
        </div>
        <div class="col-sm-5">
        ...
        <input type="submit" name="update" value="Edit" class="btn btn-primary" style="margin-top: 30px; margin-right: 20px; margin-left: 15px" disabled="">
        <a href="{{url('/halamanadmin')}}" class="btn btn-dark" style="margin-top: 30px; margin-right: 20px">Kembali</a>
        <!-- <a href="/halamanadmin/edit/{{ $admin->id_helpdesk }}" class="btn btn-primary" style="margin-top: 30px; margin-right: 20px">Edit</a> -->
       <!--  <a href="/halamanadmin" class="btn btn-dark" style="margin-top: 30px; margin-right: 20px">Kembali</a> -->
    </form>
            <br>
            <!-- Light table -->
