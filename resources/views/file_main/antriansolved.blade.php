                  ...
                  <div class="row">
                    <div class="col-sm-9">
                      <!-- <div class="form-group">
                        <label class="form-control-label" for="no_antrian">No NIP</label>
                        <input type="text" id="no_antrian" name="no_antrian" class="form-control" placeholder="No NIP" onchange="cekNip(this)"s/> -->
          ...
          <div class="card">
            <div class="card-header">
              ...
              <!--   <div class="col-4 text-right">
               ...
               <div class="card-body">
              <form>
              @foreach ($helpdesk as $hp)
                <h1 class="heading-small mb-4" style="font-size: 24px"><b>Informasi Gangguan</b></h1>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-sm-16">
                      <div class="form-group">
                          <button href="#modal-form" role="button" style="margin-top: 7px;" class="btn btn-info"  data-toggle="modal" style="background: green !important; border-color: green !important"> <i class="fa-caret-square-o-right"></i> No antrian : <br>  <?php
                          echo $no_a;
                          ?>
                      ...
                      <div class="form-group">
                        <div>
                          <button href="#modal-form" role="button" style="margin-top: 7px; margin-left: 22px padding-left: 15px " class="btn btn-primary"  data-toggle="modal" style="background: green !important; border-color: green !important"> <i class="fa-caret-square-o-right"></i> No Tiket :  <br> TA-{{$hp->id_helpdesk}}
                          </button>
                        </div>
                         </div>
                    </div>
                    ...
                    <!-- <div class="col-lg-4"> -->
                      ...
                      <div class="form-group">
                        <div>
                          @if ($hp->status == '0')
                         <button style="margin-top: 7px; padding-left: 15px" class="btn btn-danger"  data-toggle="modal" style="background: green !important; border-color: green !important"> <i class="fa-caret-square-o-right"></i> Status : <br>Waiting</button></a>
                      @elseif ($hp->status == '1')
                          <button style="margin-top: 7px; padding-left: 15px" class="btn btn-warning"  data-toggle="modal" style="background: green !important; border-color: green !important"> <i class="fa-caret-square-o-right"></i> Status : <br> Pending</button></a>
                      @elseif($hp->status == '2')
                        <button style="margin-top: 7px; padding-left: 15px" class="btn btn-light"  data-toggle="modal" style="background: green !important; border-color: green !important"> <i class="fa-caret-square-o-right"></i> Status : <br>On Proses</button></a>
                     @elseif ($hp->status == '3') 
                        <button  style="margin-top: 7px; padding-left: 15px" class="btn btn-success"  data-toggle="modal" style="background: green !important; border-color: green !important"> <i class="fa-caret-square-o-right"></i> Status : <br> Solved</button></a>
                        @endif
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                          ...
                          <td>{{$hp->tgl_pengajuan}}</td>
                        </tr>

                        <tr>
                          <!--<th scope="row">2</th>-->
                          <td>Divisi/Departmen</td>
                          <td>{{$hp->user->divisi->divisi}}/{{$hp->user->departmen->departmen}}</td>
                        </tr>

                         <tr>
                          <!--<th scope="row">2</th>-->
                          <td>Keluhan</td>
                          <td>{{$hp->ket_masalah}}</td>
                        </tr>
                         ...
                         <tr>
                          ...
                          <td>Foto</td>
                          <!-- <td>{{$hp->foto_awal}}</td> -->
                          <td><img class="card-img-top" src="/data_file/{{ $hp->foto_awal }}" alt="Card img cap"></td>
                        </tr>
                            </tbody>
                        ...
                        <br>
                        @if($hp->status==3)
                        <a href="{{url('/antriansolved/tampil/'.$hp->id_helpdesk)}}"><button href="#modal-form" role="button" type="button" style="margin-left: 355px; margin-top: 30px;" class="btn btn-success"  data-toggle="modal" style="background: blue !important; border-color: blue !important"> <i class="ni ni-send"></i><span> More Information </span>
                        </button></a>
                      <!-- </div> -->
                      @endif
                      @endforeach
