  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-3">Edit Detail Kategori</h3>
        ...
        <form method="post" action="{{url('/detailkategori/update/'. $detail_kategori-> id)}}">
        {{ csrf_field() }}
        <div class="col-sm-5">
            <!-- <label for="id_kategori">ID Detail </label><br> -->
         <input type="hidden" name="id_detail" required="required" class="form-control" value="{{ $detail_kategori->id_detail }}" readonly>
     </div>
      <div class="col-sm-5">
            <label for="id_kategori"> Kategori </label><br>
             <select name="id_kategori" id="id_kategori" class="cari_kategori form-control">
            <option>{{ $detail_kategori->kategori->kategori }}</option>
        ...
        <div class="col-sm-5">
            ...
            <input type="text" name="detail" required="required" class="form-control" value="{{ $detail_kategori->detail }}" >
        </div>
        <div class="col-sm-5">
            <!-- <label for="status_detail">Status Detail </label><br> -->
            <input type="hidden" name="status_detail" required="required" value="0" class="form-control" value="{{ $detail_kategori->status_detail }}">
        </div>
