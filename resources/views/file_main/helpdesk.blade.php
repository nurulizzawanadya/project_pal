              ...
              <!-- <table class="table align-items-center"> -->
                ...
                <thead class="thead-light">
                  ...
                  <tr>
                    ...
                    <th scope="col">Detail Keterangan Masalah</th>
                ...
                @endif
                      @foreach($data as $d)
                      <tr>
                        <td class="text-wrap" scope="row">{{ $loop->iteration }}</td>
                        <td scope="row">{{ $d->nama }}</td>
                        <td scope="row">{{ $d->tgl_pengajuan }}</td>
                        <td class="text-wrap" scope="row">{{ $d->divisi }}</td>
                        <td class="text-wrap" scope="row">{{ $d->kategori}}</td>
                        <td class="text-wrap" scope="row">{{ $d->ket_masalah}}</td>
                        <td scope="row">
                        <?php
                         if ($d->status == 0) {
                            echo "Waiting";
                        ...
                        <td scope="row" class="text-right">
                            ...
                            <a class="dropdown-item" href="{{url('/helpdesk/editstatus/'.$d->id_helpdesk)}}">Update Status</a>
                            <a class="dropdown-item" href="{{url(/'helpdesk/detailhelpdesk/'.$d->id_helpdesk)}}">Detail</a>
                        </td>
                      </tr>
                      @endforeach
                      </tbody>
