      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="form-group mb-0">
                <h1 style="color:white; margin-top: 10px; margin-left: 10px;">Tambah Officer</h1>
            </div>
          <!-- Navbar links -->
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-3">Tambah Officer</h3>
            </div>
            <!-- <div>
            ...
            <form action="{{url('/simpanmanajemenofficer')}}" method="get">
                {{ csrf_field() }}
                <br>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama_officer" required="required">
                </div>
                <br>
                <div class="col-sm-4">
