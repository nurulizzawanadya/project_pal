...
<div class="header pb-6 d-flex align-items-center" style="min-height: 325px; background-image: url( {!! asset('assets/img/theme/kapal-1.jpeg') !!} ); background-size: 1090px; background-position:center;">
      <!-- Mask -->
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header">
             ...
             <div class="card-body">
             @foreach ($helpdesk as $hk)
                <h1 class="heading-small mb-4" style="font-size: 24px"><b>Informasi Gangguan TA- {{$hk->id_helpdesk}}</b></h1>
                <div class="pl-lg-4">
                  <div class="row">
...
<!-- 
                    ...
                    <table class="table">
                        ...
                        <thead>
                          ...
                          <!--<th scope="row">1</th>-->
                          <td>No Antrian</td>
                          <td>{{$hk->id_helpdesk}}</td>
                          
                        </tr>
                        <tr>
                          <!--<th scope="row">1</th>-->
                          <td>Tanggal Selesai</td>
                          <td>{{$hk->tgl_selesai}}</td>
                        ...
                        <tr>
                         ...
                         <tr>
                          ...
                          <td>Foto Akhir</td>
                          <!-- <td>{{$hk->foto_akhir}}</td> -->
                          <td><img class="card-img-top" src="/data_file/{{ $hk->foto_akhir }}" alt="Card img cap"></td>
                        </tr>

                         <tr>
                          <!--<th scope="row">2</th>-->
                          <td>Konfirmasi User</td>
                          <!-- <td>{{$hk->ttd}}</td> -->
                          <td><img class="card-img-top" src="/upload/{{ $hk->ttd }}" alt="Card img cap"></td>
                        </tr>

                         <tr>
                          <!--<th scope="row">2</th>-->
                          <form action="{{url('/Suksesantrian/update/'.$hk->id_helpdesk)}}" method="post">
                          @csrf
                          <!-- <input type="hidden" id="id_helpdesk" name="id_helpdesk" value="{{$hk->id_helpdesk}}">
                          <input type="hidden" id="tgl_pengajuan" name="tgl_pengajuan"  value="{{$hk->tgl_pengajuan}}">
                          <input type="hidden" id="tgl_selesai" name="tgl_selesai"  value="{{$hk->tgl_selesai}}"> 
                          <input type="hidden" id="nip" name="nip"  value="{{$hk->nip}}">
                          <input type="hidden" id="id_divisi" name="id_divisi"  value="{{$hk->id_divisi}}"> 
                          <input type="hidden" id="id_departmen" name="id_departmen"  value="{{$hk->id_departmen}}">
                          <input type="hidden" id="telp_ext" name="telp_ext"  value="{{$hk->telp_ext}}">
                          <input type="hidden" id="id_detail" name="id_detail"  value=" {{$hk->id_detail}}">
                          <input type="hidden" id="ket_masalah" name="ket_masalah"  value="{{$hk->ket_masalah}}">
                          <input type="hidden" id="trouble" name="trouble"  value=" {{$hk->trouble}}">
                          <input type="hidden" id="solved" name="solved"  value="{{$hk->solved}}">
                          <input type="hidden" id="foto_awal" name="foto_awal"  value=" {{$hk->foto_awal}}">
                          <input type="hidden" id="foto_akhir" name="foto_akhir"  value="{{$hk->foto_akhir}}">
                          <input type="hidden" id="ttd" name="ttd"  value="{{$hk->ttd}}">
                          <input type="hidden" id="officer" name="officer" value=" {{$hk->officer}}">
                          <input type="hidden" id="status" name="status" value="{{$hk->status}}"> -->
                         <td>Penilaian <br><b style="color: red;">**Penilaian Anda Masukan untuk Kami</b></td>
                          <td >
                          <input style="margin-left: 10px"  type="radio" id="rating" name="rating" value="1"
                          <?php if($hk->rating == '1') echo 'checked' ?> >
                            <label for="rating">Tidak Puas</label>

                            <input style="margin-left: 10px" type="radio" id="rating" name="rating" value="2" 
                            <?php if($hk->rating == '2') echo 'checked' ?> >
                            <label for="rating">Kurang Puas</label>

                            <input style="margin-left: 10px"type="radio" id="rating" name="rating" value="3"
                            <?php if($hk->rating == '3') echo 'checked' ?> >
                            <label for="rating">Puas</label>

                            <input style="margin-left: 10px"type="radio" id="rating" name="rating" value="4"
                            <?php if($hk->rating == '4') echo 'checked' ?> >
                            <label for="rating">Sangat Puas</label>

                            <br><br>
                            <button style="margin-right: 290px" type="submit" class="btn btn-sm btn-danger">
                            Rate
                            <i class="ace-icon fa fa-start icon-on-right bigger-110"></i>
                          </button>
                          </td>
                        </tr>
                        </form>
                 ...
                 <!--  </div>
                  ...
                  <!--  <div class="col-sm-12">
                   ...
                   <div class="col-sm-12">
                    <div class="form-group"> -->
                   <!--  <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Foto Trouble <font color="red"><sup>**Jika Perlu</sup></
@endsection
