                  ...
                  <div class="row">
                    <div class="col-sm-9">
                      ...
                      <!--   <label class="form-control-label" for="no_antrian">No Tiket</label>
                        <input type="text" id="no_antrian" name="no_antrian" class="form-control" placeholder="No tiket" onchange="cekNip(this)"/> -->
                    ...
                    <!-- <div class="col-lg-4"> -->
                      <div class="form-group">
                       ...
                       <!--  <button href="/antriannip2" role="button" style="margin-top: 7px;" class="btn btn-success"  data-toggle="modal" style="background: green !important; border-color: green !important"> <i class="fa-caret-square-o-right"></i> Cek Progress
                        </button> -->
                      </div>
                    </div>
                  </div>
...
<!-- 
                  ...
                  <div class="form-group">
                        ...
                        <!-- <label class="form-control-label" for="input-email">Email address</label>
                        <input type="email" id="input-email" class="form-control" placeholder="jesse@example.com"> -->
                       <!--  <a href="/suksesantrian"><button href="#modal-form" role="button" style="margin-left: 355px; margin-top: 0;" class="btn btn-success"  data-toggle="modal" style="background: blue !important; border-color: blue !important"> <i class="ni ni-send"></i><span> More Information </span>
                        </button></a>
                      </div>
              </div>
