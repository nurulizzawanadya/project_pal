  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-3">Tambah Spesialis</h3>
        ...
        <form method="get" action="{{url('/spesialis/simpan/')}}">
        {{ csrf_field() }}
        <div class="col-sm-5">
            <!-- <label for="id_kategori">ID Detail </label><br> -->
         <input type="hidden" name="id_spesialis" required="required" class="form-control" readonly>
     </div>
      <div class="col-sm-5">
