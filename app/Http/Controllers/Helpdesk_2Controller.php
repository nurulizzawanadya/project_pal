...
class Helpdesk_2Controller extends Controller
{
     public function index()
    {
        ...
        return view('file_main/helpdesk2', compact('data', 'user', 'divisi', 'departmen','detail_kategori'));
    ...
    public function helpdesk()
    {
        ...
        return view('file_main/helpdesk2', compact('data', 'user', 'divisi', 'departmen','detail_kategori', 'data'));
        // return view('file_main/admin', compact('admin', 'user2', 'detail_kategori', 'divisi', 'department'));
    }
